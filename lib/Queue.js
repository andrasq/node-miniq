...
function Queue( sysid, scheduler, store, runner, log ) {
    ...
    this.cron = new qcron.Cron();
    // this._cron = utils.makeCron();
    // this._cron.schedule(17000, function() { self._expireLocks });
    // this._cron.schedule(23000, function() { self._expireJobs });
    // this._cron.schedule(29000, function() { self._renewLocks });
}
