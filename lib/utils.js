...
var _ncalls = 0;
var _timeout;
function _expireCachedTime() { _lastTimestamp = -1; _timestampString = ''; _timeout = null }
...
function Mutex() {
    ...
    this.onidle = function onidle() {
        self.busy = false;
        if (self.queue.length) utils.setImmediate(self.queue.shift(), onidle, self.busy = true);
    }
}
