...
// TODO: change to MiniLogger that takes either (string) or (object, string) instead of varargs
function makeLogger( logName, stream ) {
    ...
    var loglineTemplate = '{"time":"%s","id":' + JSON.stringify(logName) + ',"type":"%s","message":%s}\n';
