...
function makeLogger( logName, stream ) {
    ...
    var loglineTemplate = ('{"time":"%s","type":"%s"' + staticInfo + ',"message":%s}\n').slice(0);
    ...
    return { __proto__: new utils.QLog(), trace: utils.varargs(vlogit, 'TRACE'), debug: utils.varargs(vlogit, 'DEBUG'),
