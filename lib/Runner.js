...
Runner.prototype.getRunningJobIds = utils.abstract('getRunningJobIds', 'callback');
...
Runner.prototype.runJobs = utils.abstract('runJobs', 'jobtype: string[]', 'jobs: Job[]', 'jobHandler: object');
