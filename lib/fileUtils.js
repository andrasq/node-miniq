...
var trimTrailingNewline = eval('true && ((nodeMajor === 0 && nodeMinor < 10) ? function(line) { return trimEol(line) } : echoLine)');
...
function makeLineReader( filepath, options ) {
    ...
    reader = {
        ...
        reopen: function reopen() {
            reader.lines = reader.lines.slice(); reader.eof = false;
            reopenStream(filepath); reopenReader(stream) },
